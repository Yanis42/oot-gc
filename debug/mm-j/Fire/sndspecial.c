/*
    ...
    Language: C++
    Code range: 0x800A6EC4 -> 0x800A7530
*/

#include "types.h"

// size = 0x760, address = 0x800FDE80
u8 special_data[1888];

// size = 0x24, address = 0x800FE5E0
static u16 sButtonOrder[18];

// size = 0x2, address = 0x80145A90
static u16 sCurrButton;

// size = 0x70, address = 0x800FE604
static u8 ImportantData[112];

typedef struct _GXTexObj {
    /* 0x0 */ u32 dummy[8];
} __anon_0x94C0F; // size = 0x20

// size = 0x20, address = 0x80140BC8
static struct _GXTexObj texObj$145;

// size = 0x20, address = 0x80140BE8
static struct _GXTexObj texObj2$146;

// size = 0x2, address = 0x80145A92
...
typedef struct PADStatus {
    ...
    /* 0x9 */ u8 analogB;
    /* 0xA */ s8 err;
} __anon_0x94CD1; // size = 0xC

typedef struct __anon_0x94E61 {
...
} __anon_0x94E61; // size = 0x1E

// size = 0x78, address = 0x80142458
struct __anon_0x94E61 DemoPad[4];

typedef struct __anon_0x9510A {
    /* 0x0 */ f32 rX;
    /* 0x4 */ f32 rY;
    /* 0x8 */ f32 rSizeX;
    /* 0xC */ f32 rSizeY;
} __anon_0x9510A; // size = 0x10

typedef struct __anon_0x951A4 {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nWidth;
    /* 0x08 */ s32 nFormat;
    /* 0x0C */ void* pData;
    /* 0x10 */ s32 nAddress;
} __anon_0x951A4; // size = 0x14

typedef struct __anon_0x952E5 {
    /* 0x0 */ f32 x;
    /* 0x4 */ f32 y;
    /* 0x8 */ f32 z;
} __anon_0x952E5; // size = 0xC

typedef struct __anon_0x95355 {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x952E5 rVecOrigTowards;
    /* 0x10 */ f32 rColorR;
    /* 0x14 */ f32 rColorG;
    /* 0x18 */ f32 rColorB;
    /* 0x1C */ f32 rVectorX;
    ...
    /* 0x36 */ s16 coordY;
    /* 0x38 */ s16 coordZ;
} __anon_0x95355; // size = 0x3C

typedef struct __anon_0x95585 {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x952E5 rS;
    /* 0x10 */ struct __anon_0x952E5 rT;
    /* 0x1C */ struct __anon_0x952E5 rSRaw;
    /* 0x28 */ struct __anon_0x952E5 rTRaw;
} __anon_0x95585; // size = 0x34

typedef struct __anon_0x9566E {
    /* 0x00 */ f32 rSum;
    /* 0x04 */ f32 rS;
    /* 0x08 */ f32 rT;
    /* 0x0C */ struct __anon_0x952E5 vec;
    /* 0x18 */ u8 anColor[4];
} __anon_0x9566E; // size = 0x1C

typedef union __anon_0x957CD {
    /* 0x0 */ u8 u8[4096];
    /* 0x0 */ u16 u16[2048];
    /* 0x0 */ u32 u32[1024];
    /* 0x0 */ u64 u64[512];
...
typedef struct __anon_0x9586A {
    /* 0x0 */ union __anon_0x957CD data;
} __anon_0x9586A; // size = 0x1000
...
} __anon_0x95B75; // size = 0x6C

typedef struct __anon_0x95ED2 {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nTMEM;
    /* 0x08 */ s32 iTLUT;
    /* 0x0C */ s32 nSizeX;
    ...
    /* 0x26 */ s16 nY1;
    /* 0x28 */ u32 nCodePixel;
} __anon_0x95ED2; // size = 0x2C

typedef enum __anon_0x961B4 {
    FMP_NONE = -1,
    FMP_PERSPECTIVE = 0,
    FMP_ORTHOGRAPHIC = 1,
} __anon_0x961B4;

typedef struct __anon_0x9623C {
    /* 0x00 */ s32 nCount;
    /* 0x04 */ f32 rScale;
    /* 0x08 */ f32 rAspect;
    ...
    /* 0x20 */ enum __anon_0x961B4 eProjection;
} __anon_0x9623C; // size = 0x24

typedef struct __anon_0x963F3 {
    ...
    /* 0x000A8 */ struct __anon_0x9510A viewport;
    /* 0x000B8 */ struct __anon_0x951A4 aBuffer[4];
    ...
    /* 0x00130 */ struct __anon_0x95355 aLight[8];
    /* 0x00310 */ struct __anon_0x95585 lookAt;
    /* 0x00344 */ s32 nCountVertex;
    /* 0x00348 */ struct __anon_0x9566E aVertex[80];
    /* 0x00C08 */ struct __anon_0x9586A TMEM;
    ...
    /* 0x3C340 */ s32 nLastX1;
    /* 0x3C344 */ s32 nLastY1;
    /* 0x3C348 */ struct __anon_0x95ED2 aTile[8];
...
} __anon_0x963F3; // size = 0x3D138

// size = 0x4, address = 0x801458C8
struct __anon_0x963F3* gpFrame;
...
typedef struct _GXColor {
    ...
    /* 0x2 */ u8 b;
    /* 0x3 */ u8 a;
} __anon_0x97193; // size = 0x4

// Range: 0x800A7318 -> 0x800A7530
