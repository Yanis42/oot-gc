/*
    ...
    Language: C++
    Code range: 0x80030C84 -> 0x80036758
*/
...
typedef struct __anon_0x4224E {
    /* 0x00 */ void* pFrame;
    /* 0x04 */ void* pSound;
    /* 0x08 */ s32 bException;
    /* 0x0C */ enum __anon_0x41EA1 eMode;
    /* 0x10 */ struct __anon_0x41F04 romCopy;
    /* 0x20 */ enum __anon_0x41FB5 eTypeROM;
    /* 0x24 */ void* apObject[16];
    /* 0x68 */ u64 nAddressBreak;
    /* 0x70 */ enum __anon_0x42113 storageDevice;
    /* 0x74 */ u8 anException[16];
} __anon_0x4224E; // size = 0x88

// size = 0x4, address = 0x801458C0
struct __anon_0x4224E* gpSystem;

typedef struct __anon_0x42585 {
    /* 0x0 */ s32 nOffsetHost;
    /* 0x4 */ s32 nAddressN64;
} __anon_0x42585; // size = 0x8

typedef struct cpu_callerID {
    /* 0x0 */ s32 N64address;
    /* 0x4 */ s32 GCNaddress;
} __anon_0x425EB; // size = 0x8

typedef struct cpu_function {
    /* 0x00 */ void* pnBase;
    /* 0x04 */ void* pfCode;
    /* 0x08 */ s32 nCountJump;
    /* 0x0C */ struct __anon_0x42585* aJump;
    /* 0x10 */ s32 nAddress0;
    /* 0x14 */ s32 nAddress1;
...
} __anon_0x4265E; // size = 0x48

typedef union __anon_0x4293A {
    /* 0x0 */ char _0s8;
    /* 0x1 */ char _1s8;
    /* 0x2 */ char _2s8;
    /* 0x3 */ char _3s8;
...
} __anon_0x4352A; // size = 0x84

typedef struct __anon_0x4378D {
    /* 0x0 */ u32 nAddress;
    /* 0x4 */ u32 nOpcodeOld;
    /* 0x8 */ u32 nOpcodeNew;
} __anon_0x4378D; // size = 0xC
...
typedef struct _CPU {
    ...
    /* 0x00040 */ union __anon_0x4293A aGPR[32];
    /* 0x00140 */ union __anon_0x42D4E aFPR[32];
    ...
    /* 0x00B64 */ struct __anon_0x4325C* apDevice[256];
    ...
    /* 0x11EA8 */ struct __anon_0x4378D aCodeHack[32];
...
} __anon_0x44569; // size = 0x40

typedef enum __anon_0x47680 {
    CS_NONE = -1,
    CS_32BIT = 0,
    CS_64BIT = 1,
} __anon_0x47680;

typedef enum __anon_0x48223 {
    RLM_NONE = -1,
    RLM_PART = 0,
    RLM_FULL = 1,
    RLM_COUNT_ = 2,
...
typedef struct __anon_0x48282 {
    /* 0x0 */ s32 iCache;
    /* 0x4 */ u32 nSize;
    /* 0x8 */ u32 nTickUsed;
    /* 0xC */ char keep;
} __anon_0x48282; // size = 0x10

typedef struct __anon_0x48396 {
    /* 0x00 */ s32 bWait;
    /* 0x04 */ s32 (* pCallback)();
    /* 0x08 */ u8* pTarget;
    /* 0x0C */ u32 nSize;
    /* 0x10 */ u32 nOffset;
} __anon_0x48396; // size = 0x14

typedef struct __anon_0x48476 {
    /* 0x00 */ s32 bWait;
    /* 0x04 */ s32 bDone;
    /* 0x08 */ s32 nResult;
    /* 0x0C */ u8* anData;
    ...
    /* 0x28 */ u32 nSize;
    /* 0x2C */ u32 nSizeRead;
} __anon_0x48476; // size = 0x30

typedef struct __anon_0x48661 {
    /* 0x0 */ s32 nPosition;
    /* 0x4 */ s32 nLineNumber;
} __anon_0x48661; // size = 0x8

typedef struct __anon_0x486C5 {
    /* 0x0 */ s32 nMode;
    /* 0x4 */ s32 nModeSave;
    /* 0x8 */ struct __anon_0x48661 save;
} __anon_0x486C5; // size = 0x10
...
} __anon_0x48B3C; // size = 0x3C

typedef struct __anon_0x48BF4 {
    /* 0x00000 */ void* pHost;
    ...
    /* 0x00214 */ u32 nSize;
    /* 0x00218 */ enum __anon_0x48223 eModeLoad;
    /* 0x0021C */ struct __anon_0x48282 aBlock[4096];
    /* 0x1021C */ u32 nTick;
    /* 0x10220 */ u8* pCacheRAM;
    /* 0x10224 */ u8 anBlockCachedRAM[1024];
    /* 0x10624 */ u8 anBlockCachedARAM[2046];
    /* 0x10E24 */ struct __anon_0x48396 copy;
    /* 0x10E38 */ struct __anon_0x48476 load;
...
typedef enum __anon_0x49141 {
    RUM_NONE = 0,
    RUM_IDLE = 1,
} __anon_0x49141;

typedef enum __anon_0x49401 {
    CM_NONE = -1,
    CM_USER = 0,
    CM_SUPER = 1,
    CM_KERNEL = 2,
...
static s32 cpuHackIdle(struct _CPU* pCPU) {
    ...
    // Local variables
    struct __anon_0x4224E* pSystem; // r3
}
...
// Range: 0x80035F34 -> 0x800361F4
s32 cpuException(struct _CPU* pCPU, enum __anon_0x4A3F9 eCode, s32 nMaskIP) {
    // Parameters
    // struct _CPU* pCPU; // r27
    // enum __anon_0x4A3F9 eCode; // r28
    // s32 nMaskIP; // r29
}

// Range: 0x80035E24 -> 0x80035F34
static s32 cpuMakeDevice(struct _CPU* pCPU, s32* piDevice, void* pObject, s32 nOffset, u32 nAddress0, u32 nAddress1, s32 nType) {
    ...
    // Local variables
    struct __anon_0x4325C* pDevice; // r1+0x28
    s32 iDevice; // r31
}

// Range: 0x80035D80 -> 0x80035E24
...
// Range: 0x800357FC -> 0x800358D4
static s32 cpuGetMode(u64 nStatus, enum __anon_0x49401* peMode) {
    // Parameters
    // u64 nStatus; // r1+0x0
    // enum __anon_0x49401* peMode; // r1+0x8
}

// Range: 0x800356B8 -> 0x800357FC
static s32 cpuGetSize(u64 nStatus, enum __anon_0x47680* peSize, enum __anon_0x49401* peMode) {
    // Parameters
    // u64 nStatus; // r29
    // enum __anon_0x47680* peSize; // r30
    // enum __anon_0x49401* peMode; // r31

    // Local variables
    enum __anon_0x49401 eMode; // r1+0x18
}
...
static s32 cpuSetCP0_Status(struct _CPU* pCPU, u64 nStatus) {
    ...
    // Local variables
    enum __anon_0x49401 eMode; // r1+0x28
    enum __anon_0x49401 eModeLast; // r1+0x24
    enum __anon_0x47680 eSize; // r1+0x20
    enum __anon_0x47680 eSizeLast; // r1+0x1C
}

// Range: 0x80035458 -> 0x80035624
...
// Range: 0x80035114 -> 0x800351B0
s32 __cpuERET(struct _CPU* pCPU) {
    // Parameters
    // struct _CPU* pCPU; // r1+0x0
}

// Range: 0x80035100 -> 0x80035114
...
// Range: 0x80034F38 -> 0x80034F50
s32 cpuSetDeviceGet(struct __anon_0x4325C* pDevice, s32 (* pfGet8)(void*, u32, char*), s32 (* pfGet16)(void*, u32, s16*), s32 (* pfGet32)(void*, u32, s32*), s32 (* pfGet64)(void*, u32, s64*)) {
    // Parameters
    // struct __anon_0x4325C* pDevice; // r1+0x4
...
// Range: 0x80034F20 -> 0x80034F38
s32 cpuSetDevicePut(struct __anon_0x4325C* pDevice, s32 (* pfPut8)(void*, u32, char*), s32 (* pfPut16)(void*, u32, s16*), s32 (* pfPut32)(void*, u32, s32*), s32 (* pfPut64)(void*, u32, s64*)) {
    // Parameters
    // struct __anon_0x4325C* pDevice; // r1+0x4
...
static s32 cpuGetGPR(struct _CPU* pCPU, s32* anRegister) {
    ...
    // Local variables
    s32 iRegister; // r1+0x8
    enum __anon_0x47680 eSize; // r1+0x18
...
s32 cpuGetAddressBuffer(struct _CPU* pCPU, void* ppBuffer, u32 nAddress) {
    ...
    // Local variables
    struct __anon_0x4325C* pDevice; // r1+0x8
}

// Range: 0x80034448 -> 0x800345D8
...
s32 cpuFindFunction(struct _CPU* pCPU, s32 theAddress, struct cpu_function** tree_node) {
    ...
    // Local variables
    struct __anon_0x4325C** apDevice; // r26
    u8* aiDevice; // r27
    u32 opcode; // r1+0x34
    u8 follow; // r1+0x3D
    u8 valid; // r16
