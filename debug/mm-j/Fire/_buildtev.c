/*
    ...
    Language: C++
    Code range: 0x800A2D38 -> 0x800A6148
*/
...
} __anon_0x9161C; // size = 0x14

// size = 0x50, address = 0x800FDCF8
static struct TevColorOp sUsualOps[4];

// size = 0x10, address = 0x800FDD48
static enum _GXTevColorArg sUsualCArgs[4];

// size = 0x10, address = 0x800FDD58
static enum _GXTevAlphaArg sUsualAArgs[4];

// size = 0x8, address = 0x801456B0
static s32 zeroType$182[2];

// size = 0x20, address = 0x800FDD68
static s32 texelType$183[2][4];

// size = 0x10, address = 0x800FDD88
...
} __anon_0x91D29; // size = 0x30C

// size = 0x30C, address = 0x8013FF20
static struct CombineModeTev tevStages$519;

typedef enum __anon_0x927CA {
    SM_NONE = -1,
    SM_RUNNING = 0,
    SM_STOPPED = 1,
} __anon_0x927CA;

typedef struct __anon_0x92833 {
    /* 0x0 */ s32 nSize;
    /* 0x4 */ s32 nOffsetRAM;
    /* 0x8 */ s32 nOffsetROM;
    /* 0xC */ s32 (* pCallback)();
} __anon_0x92833; // size = 0x10

typedef enum __anon_0x928E4 {
    SRT_NONE = -1,
    SRT_MARIO = 0,
    SRT_WAVERACE = 1,
    SRT_MARIOKART = 2,
...
typedef struct __anon_0x92B89 {
    /* 0x00 */ void* pFrame;
    /* 0x04 */ void* pSound;
    /* 0x08 */ s32 bException;
    /* 0x0C */ enum __anon_0x927CA eMode;
    /* 0x10 */ struct __anon_0x92833 romCopy;
    /* 0x20 */ enum __anon_0x928E4 eTypeROM;
    /* 0x24 */ void* apObject[16];
    /* 0x68 */ u64 nAddressBreak;
    /* 0x70 */ enum __anon_0x92A48 storageDevice;
    /* 0x74 */ u8 anException[16];
} __anon_0x92B89; // size = 0x88

// size = 0x4, address = 0x801458C0
struct __anon_0x92B89* gpSystem;

// Range: 0x800A5FB0 -> 0x800A6148
