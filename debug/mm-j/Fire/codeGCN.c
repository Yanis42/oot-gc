/*
    ...
    Language: C++
    Code range: 0x8001CD94 -> 0x8001CDE8
*/
...
typedef struct tXL_FILE {
    ...
    /* 0x10 */ s32 nSize;
    /* 0x14 */ s32 nOffset;
    /* 0x18 */ enum __anon_0x23CAC eType;
    /* 0x1C */ s32 iLine;
    /* 0x20 */ s32 nLineNumber;
    /* 0x24 */ struct DVDFileInfo info;
} __anon_0x241B2; // size = 0x60

// size = 0x4, address = 0x80145950
static void* gpBufferFunction;

// size = 0x4, address = 0x80145954
