/*
    ...
    Language: C89
    Code range: 0x80011A6C -> 0x8001226C
*/

#include "types.h"

typedef enum __anon_0x160C1 {
...
typedef enum __anon_0x1620B {
    VI_XFBMODE_SF = 0,
    VI_XFBMODE_DF = 1,
} __anon_0x1620B;

typedef struct _GXRenderModeObj {
    /* 0x00 */ enum __anon_0x160C1 viTVmode;
    /* 0x04 */ u16 fbWidth;
    /* 0x06 */ u16 efbHeight;
    /* 0x08 */ u16 xfbHeight;
    /* 0x0A */ u16 viXOrigin;
    ...
    /* 0x0E */ u16 viWidth;
    /* 0x10 */ u16 viHeight;
    /* 0x14 */ enum __anon_0x1620B xFBmode;
    /* 0x18 */ u8 field_rendering;
    /* 0x19 */ u8 aa;
    /* 0x1A */ u8 sample_pattern[12][2];
    /* 0x32 */ u8 vfilter[7];
} __anon_0x162BC; // size = 0x3C

typedef struct _GXTexObj {
    /* 0x0 */ u32 dummy[8];
} __anon_0x1666E; // size = 0x20

// Range: 0x80012088 -> 0x8001226C
